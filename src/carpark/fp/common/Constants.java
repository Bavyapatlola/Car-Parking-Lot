...
public class Constants {
    ...
    public final static String CSS_URL = "carpark/fp/application.css";
    public final static String USER_REGISTRATION_URL = "/carpark/fp/view/UserRegistration.fxml";
    public final static String ADMINHOME_URL = "/carpark/fp/view/AdminHome.fxml";
    public final static String CUSTHOME_URL = "/carpark/fp/view/CustomerHome.fxml";
    public final static String LOGIN_URL = "/carpark/fp/view/Login.fxml";
    public final static String ADMIN_ACCESS_URL = "/carpark/fp/view/AdminAccess.fxml";
    public final static String PARKING_LOT_DETAILS_URL = "/carpark/fp/view/ParkingLotDetails.fxml";
    public final static String BOOK_PARKING = "/carpark/fp/view/BookParking.fxml";
    public final static String ViewLog = "/carpark/fp/view/ViewBooking.fxml";
